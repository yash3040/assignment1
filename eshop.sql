...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2018 at 01:00 PM
...
(1, '22nd and 9th', 'Mumbai', 22),
(2, '22nd and 9th', 'Mumbai', 22),
(3, 'My Street', 'Perth City', 268),
(4, 'aecw', 'Mumbai', 22),
(5, 'asda', 'asd', 112),
(6, 'asda', 'asd', 112),
(7, 'daswwa', 'dewasd', 355),
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `is_trending` tinyint(1) DEFAULT NULL COMMENT '0 = No, 1 = Yes',
  `short_desc` text,
  `description` text,
  `delivery_desc` text,
  `shipping_desc` text,
...
INSERT INTO `item` (`id`, `name`, `sku`, `category_id`, `price`, `color_id`, `is_trending`, `short_desc`, `description`, `delivery_desc`, `shipping_desc`, `sizeguide_desc`) VALUES
(1, 'U.S. Polo Assn. Full Sleeve Plain TShirts for Men', 'mag209_prod1', 4, 90, 9, 1, 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit. Sed At Ante. Mauris Eleifend, Quam A Vulputate Dictum, Massa Quam Dapibus Leo, Eget Vulputate Orci Purus Ut Lorem. In Fringilla Mi In Ligula. Pellentesque Aliquam Quam Vel Dolor. Every Item Is A Vital Part Of A Woman''s Wardrobe.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed at ante. Mauris eleifend, quam a vulputate dictum, massa quam dapibus leo, eget vulputate orci purus ut lorem. In fringilla mi in ligula. Pellentesque aliquam quam vel dolor. Nunc adipiscing. Sed quam odio, tempus ac, aliquam molestie, varius ac, tellus. Vestibulum ut nulla aliquam risus rutrum interdum. Pellentesque lorem. Curabitur sit amet erat quis risus feugiat viverra. Pellentesque augue justo, sagittis et, lacinia at, venenatis non, arcu. Nunc nec libero. In cursus dictum risus. Etiam tristique nisl a', 'We offer the following delivery options for 24c ours over the world. Deliveries are not made on Saturdays, Sundays or on public holidays. A specific time slot cannot be specified with any of our delivery options. Please refer to the Terms and Conditions of Sale.', 'Before we can dispatch your purchases, we may need to confirm your details with your card issuer. We will do our best to keep delays to a minimum Our delivery time starts from the moment an order is accepted and includes a 48 hour period where your items will be processed and dispatched by our warehouse', '<div class="table-responsive"><table class="table tbldtl"><thead><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table></div>'),
(2, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men_2', 'mag209_prod1', 4, 110, 11, 1, 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit. Sed At Ante. Mauris Eleifend, Quam A Vulputate Dictum.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed at ante. Mauris eleifend, quam a vulputate dictum, massa quam dapibus leo, eget vulputate orci purus ut lorem. In fringilla mi in ligula. Pellentesque aliquam quam vel dolor.', 'We offer the following delivery options for 24c ours over the world. Deliveries are not made on Saturdays, Sundays or on public holidays. A specific time slot cannot be specified with any of our delivery options. Please refer to the Terms and Conditions of Sale.', 'Before we can dispatch your purchases, we may need to confirm your details with your card issuer. We will do our best to keep delays to a minimum Our delivery time starts from the moment an order is accepted and includes a 48 hour period where your items will be processed and dispatched by our warehouse', '<div class="table-responsive"><table class="table tbldtl"><thead><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table></div>'),
(3, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men_3', 'mag209_prod1', 4, 10, 12, 1, 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit. Sed At Ante. Mauris Eleifend, Quam A Vulputate Dictum. In fringilla mi in ligula. Pellentesque aliquam quam vel dolor.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed at ante. Mauris eleifend, quam a vulputate dictum, massa quam dapibus leo, eget vulputate orci purus ut lorem. In fringilla mi in ligula. Pellentesque aliquam quam vel dolor. Sed At Ante. Mauris Eleifend, Quam A Vulputate Dictum. In fringilla mi in ligula. Pellentesque aliquam quam vel dolor.', 'We offer the following delivery options for 24c ours over the world. Deliveries are not made on Saturdays, Sundays or on public holidays. A specific time slot cannot be specified with any of our delivery options. Please refer to the Terms and Conditions of Sale.', 'Before we can dispatch your purchases, we may need to confirm your details with your card issuer. We will do our best to keep delays to a minimum Our delivery time starts from the moment an order is accepted and includes a 48 hour period where your items will be processed and dispatched by our warehouse', '<div class="table-responsive"><table class="table tbldtl"><thead><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table></div>'),
(4, 'Shirt', 'me', 4, 1200, 10, 1, 'simple shirt', 'A simple black shirt', 'not available in india', 'not available in india', 'only XL'),
(5, 'Trouser', 'me', 6, 3000, 10, 1, 'black trouser', 'a black cotton trouser', 'available in india', 'available in india', 'Only XL'),
(6, 'wwf', 'wef', 6, 231, 2, 1, 'qd', 'dq', 'qd', NULL, 'q'),
(7, 'asdfsad', 'asdasd', 8, 120, 3, 1, 'acaacasc', 'acaacascacaacascacaacascacaacascacaacascacaacascacaacascacaacascacaacascacaacasc', 'acaacascacaacascacaacascacaacasc', 'acaacascacaacascvvvasdvasd', 'vcavvaeacaacascacaacascacaacascvdaewevvcavvaeacaacascacaacascacaacascvdaewev'),
(8, 'caewac23c', 'ceqwc3e23', 8, 200, 5, 1, 'vcavvaeacaacascacaacascacaacascvdaewev', 'vcavvaeacaacascacaacascacaacascvdaewevvcavvaeacaacascacaacascacaacascvdaewevvcavvaeacaacascacaacascacaacascvdaewevvcavvaeacaacascacaacascacaacascvdaewev', 'vcavvaeacaacascacaacascacaacascvdaewevvcavvaeacaacascacaacascacaacascvdaewev', 'vcavvaeacaacascacaacascacaacascvdaewevasdcfaewsaewqwqe1213123131313', ''),
(9, 'sdgfs', 'sgs', 2, 1231, 2, 1, 'ads', 'a', 'a', 'a', 'a');
...
CREATE TABLE IF NOT EXISTS `item_images` (
  ...
  `is_primary` tinyint(1) DEFAULT NULL COMMENT '0 = No, 1 = Yes',
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10 ;
...
INSERT INTO `item_images` (`id`, `item_id`, `item_image_url`, `is_primary`) VALUES
(1, 1, 'new-thumb-01.jpg', 1),
(2, 2, 'new-thumb-02.jpg', 1),
(3, 3, 'new-thumb-03.jpg', 1),
(4, 4, 'new-thumb-04.jpg', 1),
(5, 5, 'new-thumb-05.jpg', 1),
(6, 6, 'new-thumb-06.jpg', 1),
(7, 7, 'new-thumb-07.jpg', 1),
(8, 8, 'new-thumb-08.jpg', 1),
(9, 9, 'new-thumb-02.jpg', 1);
...
(1, 1, 2, 'Too much long', 3, '2018-02-02 08:27:59'),
(2, 2, 3, 'Too bright color', 4, '2018-02-02 08:28:03'),
(3, 1, 5, 'zshtber', 3, '2018-02-01 23:47:18'),
(4, 2, 5, '3rEQWF', 4, '2018-02-02 16:20:49'),
(5, 1, 4, 'qafe', 5, '2018-02-02 08:06:11'),
(6, 1, 1, 'de', 4, '2018-02-02 09:45:47');
...
(1, 'harsh.chauhan@internal.mail'),
(2, 'harshil.suvagiya@internal.mail'),
(3, 'krunal.rathod@internal.mail'),
(4, 'sajdh@jsak.asd');
...
(1, 'User1', 'First - lorem ipsum suffered alteration in aome from, by injected humor , or randomized words which don''t look even slightly believable.There are many varation of passenger randomized words which don''t look even slightly believable'),
(2, 'User2', 'Second - lorem ipsum suffered alteration in aome from, by injected humor , or randomized words which don''t look even slightly believable.There are many varation of passenger randomized words which don''t look even slightly believable'),
(3, 'User3', 'Third - lorem ipsum suffered alteration in aome from, by injected humor , or randomized words which don''t look even slightly believable.There are many varation of passenger randomized words which don''t look even slightly believable'),
(4, 'User4', 'Fourth - lorem ipsum suffered alteration in aome from, by injected humor , or randomized words which don''t look even slightly believable.There are many varation of passenger randomized words which don''t look even slightly believable');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `is_active` tinyint(4) DEFAULT NULL COMMENT '0 = No, 1 = Yes',
  PRIMARY KEY (`id`),
...
(1, 'yash1234', '50db5d2fe2243c741745c902df1f290b', 'Yash', 'Patel', 'Male', 'yashpatel@internal.mail', '2131233214', '4859237847', 1, 2, 1),
(2, 'harsh1234', 'ec1658b4aa3a9b7b7e354439257adae1', 'Harsh', 'Chauhan', 'Male', 'harshchauhan@internal.mail', '4398128923', '1234563421', 3, 4, 0),
(3, 'anyajoy123', '8bc19d67e2a52862d0a33738361be20f', 'Anya', 'Joy', 'Female', 'anyaJOYat123@mail.com', '1231233455', '5463241236', 5, 6, 1),
(4, 'asdasd123', 'c8dae2ac93bd33ff6dfaeeda8eda2bff', 'Asd', 'Asd', 'Male', 'asdASDat123@mail.mail', '1231231230', '3545566778', 8, 7, NULL),
(5, 'harsh1234_2', 'ec1658b4aa3a9b7b7e354439257adae1', 'Harsh', 'Chauhan', 'Male', 'harsh.chauhan@internal.mail', '9875675645', '2334455634', NULL, NULL, NULL),
(6, 'harshil_1', '34625b0f803e57582b967ea808dd4ff8', 'Harshil', 'Suvagiya', 'Male', 'harshil.suvagiya@internal.mail', '5656564656', '1232342342', NULL, NULL, NULL),
(7, 'eshop__admin', '5191a815bf1c6cff3ff7455b0354c55f', NULL, NULL, NULL, 'yash.patel@internal.mail', NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `fk_address_state` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`);

--
-- Constraints for table `attributes_options`
--
ALTER TABLE `attributes_options`
  ADD CONSTRAINT `fk_attributes_options_item_attributes` FOREIGN KEY (`attribute_id`) REFERENCES `item_attributes` (`id`);
...
ALTER TABLE `item_images`
  ADD CONSTRAINT `fk_item_images_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`);

--
-- Constraints for table `item_options`
--
ALTER TABLE `item_options`
  ADD CONSTRAINT `fk_item_options_attributes_options` FOREIGN KEY (`ao_id`) REFERENCES `attributes_options` (`id`),
  ADD CONSTRAINT `fk_item_options_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`);

--
-- Constraints for table `item_review`
--
ALTER TABLE `item_review`
  ADD CONSTRAINT `fk_item_review_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `fk_item_review_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_bill_add_user_address` FOREIGN KEY (`billing_add_id`) REFERENCES `address` (`id`),
  ADD CONSTRAINT `fk_ship_add_user_address` FOREIGN KEY (`shipping_add_id`) REFERENCES `address` (`id`);

--
-- Constraints for table `wishlist`
--
ALTER TABLE `wishlist`
  ADD CONSTRAINT `fk_wishlist_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`),
